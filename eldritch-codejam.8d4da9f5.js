...
},{"./state":"Oken"}],"HMLS":[function(require,module,exports) {
...
exports.updateStages = exports.setStageDeck = exports.setDeck = exports.setCountCards = exports.setColorDeck = exports.setAllDecks = exports.mainDeck = exports.getRandom = exports.deck = void 0;
...
const setColorDeck = (colorDeck, arr, diffMust, diff1, diff2, diff3, count) => {
  let arrMust = arr.filter(card => card.difficulty === diffMust);
  let arrMaybe = arr.filter(card => card.difficulty === diff1 || card.difficulty === diff2 || card.difficulty === diff3); // console.log('arrMust = ', arrMust);
  // console.log('arrMaybe = ', arrMaybe);

  deck[colorDeck].length = 0;

  while (deck[colorDeck].length < arrMust.length && deck[colorDeck].length < deck[count]) {
...
const setDeck = () => {
  ...
  if (_global.game.difficulty === 'veryeasy') {
    setColorDeck('greenCardsDeck', _mythicCards.greenCards, 'easy', 'normal', 'normal', 'normal', 'greenCardsCount');
    setColorDeck('blueCardsDeck', _mythicCards.blueCards, 'easy', 'normal', 'normal', 'normal', 'blueCardsCount');
    setColorDeck('brownCardsDeck', _mythicCards.brownCards, 'easy', 'normal', 'normal', 'normal', 'brownCardsCount');
  }
  ...
  if (_global.game.difficulty === 'veryhard') {
    setColorDeck('greenCardsDeck', _mythicCards.greenCards, 'hard', 'normal', 'normal', 'normal', 'greenCardsCount');
    setColorDeck('blueCardsDeck', _mythicCards.blueCards, 'hard', 'normal', 'normal', 'normal', 'blueCardsCount');
    setColorDeck('brownCardsDeck', _mythicCards.brownCards, 'hard', 'normal', 'normal', 'normal', 'brownCardsCount');
  }
};

exports.setDeck = setDeck;

const setStageDeck = (stageDeck, stageDeck2, stageDeck3, stage) => {
  stageDeck.length = 0;
  const blueArr = _global.game[stage].blueCards;
  const brownArr = _global.game[stage].brownCards;
  const greenArr = _global.game[stage].greenCards;

  while (stageDeck.length < blueArr) {
    const rand = getRandom(deck.blueCardsDeck);
    const newElem = deck.blueCardsDeck[rand];

    if (stageDeck.indexOf(newElem) === -1 && stageDeck2.indexOf(newElem) === -1 && stageDeck3.indexOf(newElem) === -1) {
...
exports.setStageDeck = setStageDeck;
...
exports.setAllDecks = setAllDecks;

const updateStages = (shownCard, numCard) => {
  if (shownCard.color === 'green') {
    if (numCard < firstDeck.length) {
      _global.game.firstStage.greenCards -= 1;
    } else if (numCard < firstDeck.length + secondDeck.length) {
      _global.game.secondStage.greenCards -= 1;
    } else {
      _global.game.thirdStage.greenCards -= 1;
    }
  }

  if (shownCard.color === 'blue') {
    if (numCard < firstDeck.length) {
      _global.game.firstStage.blueCards -= 1;
    } else if (numCard < firstDeck.length + secondDeck.length) {
      _global.game.secondStage.blueCards -= 1;
    } else {
      _global.game.thirdStage.blueCards -= 1;
    }
  }

  if (shownCard.color === 'brown') {
    if (numCard < firstDeck.length) {
      _global.game.firstStage.brownCards -= 1;
    } else if (numCard < firstDeck.length + secondDeck.length) {
      _global.game.secondStage.brownCards -= 1;
    } else {
      _global.game.thirdStage.brownCards -= 1;
    }
  }
...
},{"../../data/mythicCards":"tS8o","./global":"OZyt","./state":"Oken"}],"BnAC":[function(require,module,exports) {
...
},{"../assets/Ancients/index":"dPcB"}],"MpO1":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showDeck = exports.setActiveMixBtn = exports.hideDeck = void 0;

var _ancients = require("../../data/ancients");

var _cardFlipper = require("./cardFlipper");
...
exports.hideDeck = hideDeck;

const showDeck = () => {
  currCardElem.classList.remove('hide');
};

exports.showDeck = showDeck;
...
const setGame = () => {
  ...
  _global.game.firstStage = structuredClone(ancient.firstStage);
  _global.game.secondStage = structuredClone(ancient.secondStage);
  _global.game.thirdStage = structuredClone(ancient.thirdStage);
  console.log('game = ', _global.game);
  (0, _state.setState)();
  (0, _deck.setDeck)();
  (0, _deck.setAllDecks)();
  (0, _cardFlipper.resetNumCard)();
};
...
},{"../../data/ancients":"cHZT","./cardFlipper":"lDUI","./deck":"sFLM","./global":"OZyt","./state":"Oken"}],"lDUI":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showNextCard = exports.showCurrCard = exports.resetNumCard = exports.hideCardElem = void 0;
...
const showNextCard = () => {
  ...
  (0, _mixButton.showDeck)();

  if (_deck.mainDeck.length > 0) {
    const nextCard = _deck.mainDeck.pop(); // console.log(nextCard.color);


    (0, _deck.updateStages)(nextCard, numCard);
    showCurrCard(nextCard);
    numCard++;
  } else {
    resetNumCard();
    (0, _mixButton.hideDeck)();
  }
};

exports.showNextCard = showNextCard;

const hideCardElem = currCard => {
  currCardElem.style.opacity = 0;
};

exports.hideCardElem = hideCardElem;

const resetNumCard = () => {
  numCard = 0;
};

exports.resetNumCard = resetNumCard;
nextCardElem.addEventListener('click', showNextCard);
},{"./deck":"sFLM","./mix-button":"MpO1"}],"Qwc0":[function(require,module,exports) {
"use strict";
...
const setActive = div => {
  ...
  (0, _global.resetGame)();
  (0, _mixButton.hideDeck)(); // console.log('difficulty = ', diffs.get(text), text);
...
const levels = document.querySelector('.levels'); // console.dir(levels);
...
const setActive = div => {
  ...
  (0, _global.resetGame)();
  (0, _mixButton.hideDeck)(); // resetNumCard();
